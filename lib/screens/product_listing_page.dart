...
//
//  ProductListingPage(this.categoryId, this.categoryName);
//
//  @override
...
//      title: Text(
//        widget.categoryName,
//        style: TextStyle(color: Constants.myWhite, fontSize: 14.0),
//      ),
//    );
//  }
//
...
//            } else {
//              return _itemListViewBuilder(snapshot.data);
//            }
//        }
//      },
//    );
//  }
//
//  Widget _itemListViewBuilder(Map<String, dynamic> snapshot) {
//    Widget _listWidget;
//    if (snapshot['products'].length > 0) {
//      final List<dynamic> productList = snapshot['products'].map((items) {
...
class ProductLisPage extends StatefulWidget {
  final Map<String, dynamic> snapshotData;
  final String categoryName;

  ProductLisPage(this.snapshotData, this.categoryName);

  @override
  _ProductLisPageState createState() => _ProductLisPageState();
}

class _ProductLisPageState extends State<ProductLisPage> {
  ...
  Widget _productListViewBuilder(final SubCategoryData _subData) {
    Widget _listWidget;
    if (_subData != null &&
        _subData.products != null &&
        _subData.products.length > 0) {
      final List<dynamic> _productList = _subData.products.map((items) {
      ...
      child: Column(
        ...
        children: <Widget>[
          _subData != null &&
                  _subData.products != null &&
                  _subData.products.length > 0
              ? _productListViewBuilder(_subData)
              : WidgetPage.noItemFoundWidget(),
          _subData != null &&
                  _subData.products != null &&
                  _subData.products.length > 0
              ? WidgetPage.thatAllFolks(_subData.products.length, 6)
              : Container(),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _subCatData != null &&
              _subCatData.products != null &&
              _subCatData.products.length > 0
